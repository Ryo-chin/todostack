...
public interface TodostackEnv {
    ...
    /** The key of the configuration. e.g. /tmp/lastaflute/todostack */
    ...
    /** The key of the configuration. e.g. returnpath@todostack.com */
    String MAIL_RETURN_PATH = "mail.return.path";

    /** The key of the configuration. e.g. todostack-support@annie.example.com */
    String MAIL_ADDRESS_SUPPORT = "mail.address.support";

    /** The key of the configuration. e.g. org.h2.Driver */
    String JDBC_DRIVER = "jdbc.driver";

    /** The key of the configuration. e.g. jdbc:h2:file:$classes(com.todostack.dbflute.allcommon.DBCurrent.class)/../../etc/testdb/todostackdb */
    String JDBC_URL = "jdbc.url";

    /** The key of the configuration. e.g. todostackdb */
    ...
    /** The key of the configuration. e.g. localhost:8090/todostack */
     ...
     * The value is, e.g. /tmp/lastaflute/todostack <br>
     ...
     * The value is, e.g. returnpath@todostack.com <br>
     ...
     * The value is, e.g. todostack-support@annie.example.com <br>
     * comment: Mail Address for Todostack Support
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
     ...
     * The value is, e.g. jdbc:h2:file:$classes(com.todostack.dbflute.allcommon.DBCurrent.class)/../../etc/testdb/todostackdb <br>
     ...
     * The value is, e.g. todostackdb <br>
     ...
     * The value is, e.g. localhost:8090/todostack <br>
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends ObjectiveConfig implements TodostackEnv {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getLastaDiSmartDeployMode() {
            return get(TodostackEnv.lasta_di_SMART_DEPLOY_MODE);
        }

        public String getDevelopmentHere() {
            return get(TodostackEnv.DEVELOPMENT_HERE);
        }

        public boolean isDevelopmentHere() {
            return is(TodostackEnv.DEVELOPMENT_HERE);
        }

        public String getEnvironmentTitle() {
            return get(TodostackEnv.ENVIRONMENT_TITLE);
        }

        public String getFrameworkDebug() {
            return get(TodostackEnv.FRAMEWORK_DEBUG);
        }

        public boolean isFrameworkDebug() {
            return is(TodostackEnv.FRAMEWORK_DEBUG);
        }

        public String getTimeAdjustTimeMillis() {
            return get(TodostackEnv.TIME_ADJUST_TIME_MILLIS);
        }

        public Long getTimeAdjustTimeMillisAsLong() {
            return getAsLong(TodostackEnv.TIME_ADJUST_TIME_MILLIS);
        }

        public String getLogLevel() {
            return get(TodostackEnv.LOG_LEVEL);
        }

        public String getLogConsoleLevel() {
            return get(TodostackEnv.LOG_CONSOLE_LEVEL);
        }

        public String getLogFileBasedir() {
            return get(TodostackEnv.LOG_FILE_BASEDIR);
        }

        public String getMailSendMock() {
            return get(TodostackEnv.MAIL_SEND_MOCK);
        }

        public boolean isMailSendMock() {
            return is(TodostackEnv.MAIL_SEND_MOCK);
        }

        public String getMailSmtpServerMainHostAndPort() {
            return get(TodostackEnv.MAIL_SMTP_SERVER_MAIN_HOST_AND_PORT);
        }

        public String getMailSubjectTestPrefix() {
            return get(TodostackEnv.MAIL_SUBJECT_TEST_PREFIX);
        }

        public String getMailReturnPath() {
            return get(TodostackEnv.MAIL_RETURN_PATH);
        }

        public String getMailAddressSupport() {
            return get(TodostackEnv.MAIL_ADDRESS_SUPPORT);
        }

        public String getJdbcDriver() {
            return get(TodostackEnv.JDBC_DRIVER);
        }

        public String getJdbcUrl() {
            return get(TodostackEnv.JDBC_URL);
        }

        public String getJdbcUser() {
            return get(TodostackEnv.JDBC_USER);
        }

        public String getJdbcPassword() {
            return get(TodostackEnv.JDBC_PASSWORD);
        }

        public String getJdbcConnectionPoolingSize() {
            return get(TodostackEnv.JDBC_CONNECTION_POOLING_SIZE);
        }

        public Integer getJdbcConnectionPoolingSizeAsInteger() {
            return getAsInteger(TodostackEnv.JDBC_CONNECTION_POOLING_SIZE);
        }

        public String getServerDomain() {
            return get(TodostackEnv.SERVER_DOMAIN);
        }
    }
}
