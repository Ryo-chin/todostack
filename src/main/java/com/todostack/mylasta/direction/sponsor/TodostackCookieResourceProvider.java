 ...
 * @author jflute
 */
public class TodostackCookieResourceProvider implements CookieResourceProvider {

    protected final TodostackConfig config;
    protected final InvertibleCryptographer cookieCipher;

    public TodostackCookieResourceProvider(TodostackConfig config, InvertibleCryptographer cookieCipher) {
        this.config = config;
