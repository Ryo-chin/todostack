 ...
 * @author jflute
 */
public class TodostackSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public TodostackSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
