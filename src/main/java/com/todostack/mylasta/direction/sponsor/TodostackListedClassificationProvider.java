...
import com.todostack.dbflute.allcommon.DBCurrent;
import com.todostack.mylasta.appcls.AppCDef;
 ...
 * @author jflute
 */
public class TodostackListedClassificationProvider extends TypicalListedClassificationProvider { // basically for HTML response
