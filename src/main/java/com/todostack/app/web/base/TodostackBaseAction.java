 ...
 */
package com.todostack.app.web.base;

import javax.annotation.Resource;

import org.dbflute.optional.OptionalThing;
import com.todostack.app.logic.context.AccessContextLogic;
import com.todostack.app.web.base.login.TodostackLoginAssist;
import com.todostack.app.web.base.view.HeaderBean;
import com.todostack.mylasta.action.TodostackHtmlPath;
 ...
 * @author jflute
 */
public abstract class TodostackBaseAction extends TypicalAction // has several interfaces for direct use
        implements LaValidatable<TodostackMessages>, TodostackHtmlPath {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The application type for HarBoR, e.g. used by access context. */
    protected static final String APP_TYPE = "TDS";
    ...
    @Override
    protected OptionalThing<TodostackUserBean> getUserBean() { // application may call, overriding for co-variant
    ...
    @Override
    public ActionValidator<TodostackMessages> createValidator() { // for co-variant
        return super.createValidator();
    }

    @Override
    public TodostackMessages createMessages() { // application may call
        return new TodostackMessages(); // overriding to change return type to concrete-class
    }
