...
public class TaskCIQ extends AbstractBsTaskCQ {
    ...
    public String keepTaskId_ExistsReferrer_TaskWorkList(TaskWorkCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepTaskId_NotExistsReferrer_TaskWorkList(TaskWorkCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepTaskId_SpecifyDerivedReferrer_TaskWorkList(TaskWorkCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepTaskId_QueryDerivedReferrer_TaskWorkList(TaskWorkCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepTaskId_QueryDerivedReferrer_TaskWorkListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    protected ConditionValue xgetCValueMemberId() { return _myCQ.xdfgetMemberId(); }
    protected ConditionValue xgetCValueTaskDetail() { return _myCQ.xdfgetTaskDetail(); }
    protected ConditionValue xgetCValueDisplayNum() { return _myCQ.xdfgetDisplayNum(); }
