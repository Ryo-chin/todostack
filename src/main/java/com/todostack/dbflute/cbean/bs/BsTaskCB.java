...
public class BsTaskCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public TaskCB acceptPK(Long taskId) {
        assertObjectNotNull("taskId", taskId);
        BsTaskCB cb = this;
        cb.query().setTaskId_Equal(taskId);
        return (TaskCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TaskCB acceptUniqueOf(Long taskId, Long displayNum) {
        assertObjectNotNull("taskId", taskId);assertObjectNotNull("displayNum", displayNum);
        BsTaskCB cb = this;
        cb.query().setTaskId_Equal(taskId);cb.query().setDisplayNum_Equal(displayNum);
        return (TaskCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_TaskId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_TaskId_Desc();
        return this;
    }
     ...
     *     ... = <span style="color: #553000">task</span>.<span style="color: #CC4747">getMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<TaskCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnTaskDetail() { return doColumn("TASK_DETAIL"); }
        /**
         * (表示順)DISPLAY_NUM: {+UQ, IX, NotNull, BIGINT(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnDisplayNum() { return doColumn("DISPLAY_NUM"); }
        /**
         ...
         * {select max(FOO) from TASK_WORK where ...) as FOO_MAX} <br>
         * (タスク作業)TASK_WORK by TASK_ID, named 'taskWorkList'.
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(workCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     workCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     workCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, TaskWork.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TaskWorkCB, TaskCQ> derivedTaskWork() {
            assertDerived("taskWorkList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TaskWorkCB> sq, TaskCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTaskWorkList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
