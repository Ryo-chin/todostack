...
public class MemberDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((Member)et).getEMail(), (et, vl) -> ((Member)et).setEMail((String)vl), "EMail");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "会員ID", Long.class, "memberId", null, true, true, true, "BIGINT UNSIGNED", 20, 0, null, false, null, null, null, "taskList", null, false);
    protected final ColumnInfo _columnMemberAccount = cci("MEMBER_ACCOUNT", "MEMBER_ACCOUNT", null, "会員アカウント", String.class, "memberAccount", null, false, false, true, "VARCHAR", 100, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnEMail = cci("E_MAIL", "E_MAIL", null, "Eメール", String.class, "EMail", null, false, false, true, "VARCHAR", 216, 0, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignMemberSecurityAsOne() {
        ...
        return cfi("FK_MEMBER_SECURITY_MEMBER", "memberSecurityAsOne", this, MemberSecurityDbm.getInstance(), mp, 0, org.dbflute.optional.OptionalEntity.class, true, false, true, false, null, null, false, "member", false);
    }
    ...
    public ReferrerInfo referrerTaskList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnMemberId(), TaskDbm.getInstance().columnMemberId());
        return cri("task_ibfk_1", "taskList", this, TaskDbm.getInstance(), mp, false, "member");
    }
