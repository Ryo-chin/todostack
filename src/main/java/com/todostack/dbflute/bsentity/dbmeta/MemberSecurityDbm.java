...
public class MemberSecurityDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((MemberSecurity)et).getMemberId(), (et, vl) -> ((MemberSecurity)et).setMemberId(ctl(vl)), "memberId");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "会員ID", Long.class, "memberId", null, true, false, true, "BIGINT UNSIGNED", 20, 0, null, false, null, null, "member", null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.todostack.dbflute.exentity.MemberSecurity"; }
    public String getConditionBeanTypeName() { return "com.todostack.dbflute.cbean.MemberSecurityCB"; }
    public String getBehaviorTypeName() { return "com.todostack.dbflute.exbhv.MemberSecurityBhv"; }
